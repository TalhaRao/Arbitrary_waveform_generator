###########################################################################
## Makefile generated for Simulink model 'AWFG_Phase2'. 
## 
## Makefile     : AWFG_Phase2.mk
## Generated on : Tue Aug 28 21:40:53 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AWFG_Phase2
...
MODELREF_LINK_RSPFILE_NAME = AWFG_Phase2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AWFG_Phase2
...
DEFINES_ = -DMODEL=AWFG_Phase2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=0 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DARM_PROJECT -DMW_EXTMODE_RECV_TIMEOUT_USEC=10 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=AWFG_Phase2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/AWFG_Phase2_ert_rtw/AWFG_Phase2.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/zynq/src/axi4Lite.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/AWFG_Phase2_ert_rtw/ert_main.c
...
OBJS = AWFG_Phase2.c.o axi4Lite.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/AWFG_Phase2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/AWFG_Phase2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/AWFG_Phase2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
