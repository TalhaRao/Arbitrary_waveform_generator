###########################################################################
## Makefile generated for Simulink model 'RT_CPU'. 
## 
## Makefile     : RT_CPU.mk
## Generated on : Mon Aug 27 22:02:22 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RT_CPU.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = F:/Master_Studies/Semester_2/Model_Based_Simulation/Labs/Lab_4/Practical work
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = RT_CPU_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = RT_CPU_ref.rsp
CMD_FILE                  = RT_CPU.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RT_CPU.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/RT_CPU_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=RT_CPU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/RT_CPU_ert_rtw/RT_CPU.c

MAIN_SRC = $(START_DIR)/RT_CPU_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/RT_CPU_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/RT_CPU_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
