###########################################################################
## Makefile generated for Simulink model 'uc3_preparation1_2017'. 
## 
## Makefile     : uc3_preparation1_2017.mk
## Generated on : Tue Aug 28 20:40:34 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/uc3_preparation1_2017
...
PRODUCT_NAME              = uc3_preparation1_2017
MAKEFILE                  = uc3_preparation1_2017.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = uc3_preparation1_2017_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/uc3_preparation1_2017
...
DEFINES_ = -DMODEL=uc3_preparation1_2017 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DARM_PROJECT -DMW_EXTMODE_RECV_TIMEOUT_USEC=10 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0
DEFINES_IMPLIED = -DTID01EQ=0
DEFINES_SKIPFORSIL = -DARM_PROJECT -DMW_EXTMODE_RECV_TIMEOUT_USEC=10 -DSTACK_SIZE=64 -DRT
DEFINES_STANDARD = -DMODEL=uc3_preparation1_2017 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/uc3_preparation1_2017_ert_rtw/rtGetInf.c $(START_DIR)/uc3_preparation1_2017_ert_rtw/rtGetNaN.c $(START_DIR)/uc3_preparation1_2017_ert_rtw/rt_nonfinite.c $(START_DIR)/uc3_preparation1_2017_ert_rtw/uc3_preparation1_2017.c $(START_DIR)/uc3_preparation1_2017_ert_rtw/uc3_preparation1_2017_data.c C:/ProgramData/MATLAB/SupportPackages/R2018a/toolbox/target/supportpackages/zynq/src/axi4Lite.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c

MAIN_SRC = $(START_DIR)/uc3_preparation1_2017_ert_rtw/ert_main.c
...
OBJS = rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o uc3_preparation1_2017.c.o uc3_preparation1_2017_data.c.o axi4Lite.c.o linuxinitialize.c.o
...
%.c.o : $(START_DIR)/uc3_preparation1_2017_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/uc3_preparation1_2017_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/uc3_preparation1_2017_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
