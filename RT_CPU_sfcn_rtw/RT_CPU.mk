...
## 
## Makefile     : RT_CPU.mk
## Generated on : Mon Aug 27 22:14:16 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RT_CPU_sf.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RT_CPU_sf.mexw64
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/RT_CPU_sfcn_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src
...
DEFINES_STANDARD = -DMODEL=RT_CPU -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/RT_CPU_sfcn_rtw/rtGetInf.c $(START_DIR)/RT_CPU_sfcn_rtw/rtGetNaN.c
...
%.obj : $(START_DIR)/RT_CPU_sfcn_rtw/%.c
	$(MEX) $(MEX_OPTS_FLAG) -c $(MEX_CFLAGS) -outdir "$(dir $@)" "$<"


%.obj : $(START_DIR)/RT_CPU_sfcn_rtw/%.cpp
	$(MEX) $(MEX_CPP_OPTS_FLAG) -c $(MEX_CPPFLAGS) -outdir "$(dir $@)" "$<"
